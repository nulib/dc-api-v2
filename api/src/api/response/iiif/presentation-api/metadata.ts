...
function formatSingleValuedField(value: unknown): unknown[] {
  return value ? [value] : [];
}

export function metadataLabelFields(
  source: WorkSource,
): { label: string; value: unknown }[] {
  return [
    { label: "Alternate Title", value: source.alternate_title },
    { label: "Abstract", value: source.abstract },
    { label: "Caption", value: source.caption },
    {
      label: "Contributor",
    ...
    { label: "Cultural Context", value: source.cultural_context },
    { label: "Date", value: source.date_created },
    {
      label: "Department",
      value: formatSingleValuedField(source.library_unit),
    },
    { label: "Dimensions", value: source.physical_description_size },
    {
      label: "Genre",
    ...
    { label: "Materials", value: source.physical_description_material },
    {
      label: "Notes",
      value: source.notes.map((item) => `${item.note} (${item.type})`),
    },
    { label: "Provenance", value: source.provenance },
    { label: "Publisher", value: source.publisher },
    { label: "Related Material", value: source.related_material },
    {
      label: "Related URL",
    ...
    { label: "Rights Holder", value: source.rights_holder },
    {
      label: "Rights Statement",
      value: formatSingleValuedField(source.rights_statement?.label),
    },
    { label: "Scope and Contents", value: source.scope_and_contents },
    { label: "Series", value: source.series },
    ...
    { label: "Table of Contents", value: source.table_of_contents },
    {
      label: "Technique",
